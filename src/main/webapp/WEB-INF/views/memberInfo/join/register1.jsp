...
//이용약관 동의
function CheckForm(chkForm){
	var chk1 = document.formJoin.agree_service_check.checked;
	var chk2 = document.formJoin.agree_privacy_check.checked;
...
<body style="width:100%;">	
		<form  action="register2" onSubmit="return CheckForm(this)" name="formJoin">
     ...
     <tr>
      <td align="center">
          ...
          <table width="810">
           ...
           <tr>
             <td align="center">
               <textarea name="tos" rows="15" cols="100">제1조(목적)
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
           ...
           <tr>
             <td align="center">
               <textarea name="tos" rows="15" cols="100">수집하는 개인정보의 항목
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <p class="check"><span>개인정보 수집 및 이용에 동의하십니까?</span> <input id="agree_privacy_check0" name="agree_privacy_check" type="checkbox" value=""><label for="agree_privacy_check0">동의함</label></p>
              </td>
            </tr>
            <tr>
            	<td align="center">
					  <input type="button" class="btn_order"  onclick="CheckForm()" onclick="register2"  style="margin:10px;" value="회 원 가 입">
					  <a href="../../main/main"> <button type="button" class="btn_order" style="margin:10px;">취 소 하 기</button></a>
            	</td>
            </tr>
          </tbody></table>
      </td>
