	...
	<h3>정보입력</h3>
				...
				<tr>
					...
					<tr>
						<th>비밀번호</th>
						<td colspan="3">
							<input type="password" id="user_pwd" maxlength="16" placeholder="비밀번호" onblur="<!-- validate(this,8,16) -->" onkeypress="caps_lock(event)">
					...
					<tr>
						<th>닉네임</th>
						<td><input type="text" id="user_nickname"></td>
					</tr>
					<tr>
						<th>이름</th>
					...
					<tr>
						<th>전화번호</th>
						<td>
							<select id="mm" class="sel" aria-label="월" id="user_phone" style="width: 100px;">
							...
							-
							<input type="tel" name="*" id="user_phone" maxlength="4" /> 
							- 
							<input type="tel" name="*" id="user_phone" maxlength="4" />
						</td>
					</tr>
					...
					<tr>
						<th colspan="2" align="right">
							<input type="submit" id="*" name="*" value="회원가입" onclick="chkValidate()">
